<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Fan_Milk._default" %>
            ...
            <div class="col-sm-8 main-section">
                <div class="modal-content">
                    ...
                    <form class="col-12">
                        ...
                        <asp:LinkButton ID="lbLogin" runat="server" CssClass="btn" Text="Login" OnClick="lbLogin_Click"><span aria-hidden="true" class="fas fa-sign-in-alt"><i>Login</i></span></asp:LinkButton>
                    </form>
